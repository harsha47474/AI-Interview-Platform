    ...
    >
      ...
      >
        ...
        <p className="text-sm md:text-base text-gray-400 text-center mb-8 leading-relaxed">
          Sign in to your AI interview platform to access your mock sessions,
          review feedback reports, and manage your account. You will need your
          secure login and your registered email address.
        </p>
